<template>
  <div id="app">
    <SelectPage v-show="showSelectPage" class="page-overlay" v-bind:route="route" v-on:toggleSelectPage="toggleSelectPage" v-on:setRoute="setRoute" />

    <div id="slider" v-show="!showSelectPage" v-bind:class="{ 'slider-snap-active': snapSliderScroll }">
      <AboutPage
        id="about-page"
        class="page"
    ...
    <NavigationBar v-show="!showSelectPage" v-on:setSnapScroll="setSnapScroll" v-bind:activePage="activePage" />
  </div>
</template>
    ...
    methods: {
      ...
      selectSmartRoute: function() {
        ...
        function success(pos) {
          ...
          self.$http.get("/v1/origins/geo/?lat=" + crd.longitude + "&lng=" + crd.latitude + "&active=true").then((response) => {
